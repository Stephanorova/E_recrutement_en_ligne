...
function Footer() {
  ...
  return (
    <div className='footer'>
        <div className="rigth">
          <Button style={{backgroundColor:" #022c43",border:"1px solid white",color:"white"}}>Technologie utilser</Button>
        ...
        <div className="center">
          <Button style={{ backgroundColor:" #022c43",border:"1px solid white",color:"white"}}>Autre</Button>
          <div className="autre">
            <span>Avantage dans notre société</span>
            <span>Tous les stagiaire sont possible d'embauché</span>
            <span>il y a de loisire, promenade ensemble et Cantine</span>
            <span>Colaborer avec OSTI </span>
          </div>
        </div>
        <div className="left">
          <Button style={{color:"white",backgroundColor:" #022c43",border:"1px solid white"}}>Plus des contacts</Button>
          ...
          <div className="contact">
            ...
            rovaniainarakotozandry2@gmai.com
            </span>
            <span>
